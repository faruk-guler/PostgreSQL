# İleri Düzey Yetenekler (Advanced Features)

> **Bölüm Kapsamı:** Foreign Data Wrappers (FDW), Full Text Search, Materialized Views ve Advisory Locks
...
Normal VIEW, her sorgulandığında altındaki SQL'i yeniden çalıştırır. MATERIALIZED VIEW ise sonucu diskte saklar - bir tür "cache".
