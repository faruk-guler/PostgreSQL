...
## İlgili Konular ve Çapraz Referanslar
* ⚠️ **Sorgu Anti-Pattern'leri ve Tuzaklar:** [`02-anti-patternler-ve-hatalar.md`](./02-anti-patternler-ve-hatalar.md)
* 📊 **Analitik Pencere Fonksiyonları:** [`03-aggregate-ve-window-fonksiyonlari.md`](./03-aggregate-ve-window-fonksiyonlari.md)
* ⏱️ **Sorgu Analizi ve EXPLAIN:** [`09-performance-and-benchmarking/01-explain-ve-sorgu-analizi.md`](../09-performance-and-benchmarking/01-explain-ve-sorgu-analizi.md)
