# Derinlemesine Depolama Mimarisi ve Sayfa Yapısı (Storage Internals)

> **Bölüm Kapsamı:** 8KB Sayfa Anatomisi, Tuple Başlıkları, Free Space Map (FSM), Visibility Map (VM) ve HOT Güncellemeleri

---

PostgreSQL Master Guide'ın bu ileri düzey mimari bölümünde, verinin diskteki en küçük yapı taşına iniyoruz. Veritabanı motorunun dosyaları nasıl yazdığını bilmek, hem performansı hem de veri kurtarma (Recovery) süreçlerini anlamak için kritiktir.
